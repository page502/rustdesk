...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use CloudDesktop and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade CloudDesktop Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent CloudDesktop from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by CloudDesktop"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if CloudDesktop window is open"),
        ...
        ("floating_window_tip", "It helps to keep CloudDesktop background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the CloudDesktop client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, CloudDesktop verifies the server certificate for protocols using TLS.\nWith this option enabled, CloudDesktop will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, CloudDesktop will not use UDP 31116 any more, TCP 31116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: CloudDesktop server OSS doesn't include this feature."),
