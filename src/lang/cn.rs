...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep CloudDesktop background service", "保持 CloudDesktop 后台服务"),
        ...
        ("Show CloudDesktop", "显示 CloudDesktop"),
        ("This PC", "此电脑"),
        ("or", "或"),
        ("Continue with", "使用"),
        ("Elevate", "提权"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 CloudDesktop 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，CloudDesktop 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("powered_by_me", "由 CloudDesktop 提供支持"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 CloudDesktop 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 CloudDesktop 后台服务"),
        ...
        ("About CloudDesktop", "关于 CloudDesktop"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 CloudDesktop 客户端升级至版本 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "默认情况下，对于使用 TLS 的协议，CloudDesktop 会验证服务器证书。\n启用此选项后，在验证失败时，CloudDesktop 将转为跳过验证步骤并继续连接。"),
        ("Disable UDP", "禁用 UDP"),
        ("disable-udp-tip", "控制是否仅使用TCP。\n启用此选项后，CloudDesktop 将不再使用UDP 31116，而是使用TCP 31116。"),
        ("server-oss-not-support-tip", "注意：CloudDesktop 开源服务器(OSS server) 不包含此功能。"),
